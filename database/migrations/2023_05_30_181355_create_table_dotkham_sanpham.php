...
class CreateTableDotkhamSanpham extends Migration
{
  const TABLE_NAME = 'dotkham_sanpham';
  ...
  public function up()
  {
    Schema::create(static::TABLE_NAME, function (Blueprint $table) {
      // Primary key
      $table->bigIncrements('dotkham_sanpham_id');
      ...
      // Properties
      $table->text('dotkham_sanpham_cachdung');
